...
/**
 * Comparator class for appointment class.
 *
 */
public class DesComparator implements Comparator<Appointment> {
    /**
     * Comparator method for appointment class to compare description,
     * then start date, then end date.
    ...
    public int compare(Appointment o1, Appointment o2) {
        ...
        else if (!o1.getStartDate().equals(o2.getStartDate())) return o1.getStartDate().compareTo(o2.getStartDate());
